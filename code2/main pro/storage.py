...
class Storage:
    ...
    def _make_test(self):
        # some test users for convenience
    ...
    def top_up(self, uname, amt):
        ...
        u.balance += amt
        self.save()
        return True, f"Added ${amt:.2f}, new balance ${u.balance:.2f}"
    ...
    def open_table(self, tid, uname, hrs):
        if tid in self.bookings:
            return False, f"Table {tid} occupied"
